...
class TestMasanielloManager(unittest.TestCase):
    ...
    def test_calculo_primeira_entrada(self):
        ...
        logging.info("Teste de cálculo da primeira entrada passou!")
    ...
    def test_progresso_apos_win(self):
        ...
        logging.info("Teste de progresso após WIN passou!")
    ...
    def test_progresso_apos_loss(self):
        ...
        logging.info("Teste de progresso após LOSS passou!")
    ...
    def test_atingir_meta_de_wins(self):
        ...
        logging.info("Teste de parada por meta de vitórias passou!")
    ...
    def test_atingir_limite_de_trades(self):
        ...
        logging.info("Teste de parada por limite de trades passou!")
    ...
    def test_cenario_all_in(self):
        ...
        logging.info("Teste de cenário all-in passou!")
    ...
    def test_quebra_de_banca(self):
        ...
        logging.info("Teste de quebra de banca passou!")
